...
public class ReadTest {
    ...
    public void simpleReadListStringV2007() throws IOException {
        InputStream inputStream = FileUtil.getResourcesFileInputStream("D:\\公司\\1004尹默发券不能核销\\vipcouponcode.csv");
    ...
    public void simpleReadJavaModelV2007() throws IOException {
        InputStream inputStream = FileUtil.getResourcesFileInputStream("vipcouponcode.csv");
